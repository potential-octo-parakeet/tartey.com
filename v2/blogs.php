...
<div id="container" class="cf">
  ...
  <div class="cr">
    ...
    <?php include_once('inc.blog_subnav.php');?>
    <?php switch($sk){
		case 'list'   : include_once('inc.blog_list.php');break;
		case 'myblog' : include_once('inc.blog_mine.php');break;
		case 'create' : include_once('inc.blog_create.php');break;
		default 	  : include_once('inc.blog_list.php');break;
	}?>
  </div>
</div>
</body>
