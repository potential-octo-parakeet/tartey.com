<?php
	...
	function people_you_may_know($ses_id){
		...
		$sql=mysql_query("SELECT DISTINCT user.id,user.name,user.picture50,user.location FROM user 
							WHERE /*user.id!='$ses_id' AND*/ gender='male' AND picture50!='small_pic.gif' ORDER BY RAND() LIMIT 6");
		$a=array();$i=0;
...
$(document).ready(function(){
	...
	*/
	$('.likehim').click(function(){
		alert('This feature will be available soon.');
		return false;
	});
});
</script>
<div class="column_right_box_header">Meet Our Boys</div>
...
<div class="people_umk_wrapper">
    ...
    <div style="float:left;margin-left:10px;">
        ...
        <div><a href="<?php echo $row['profile'];?>" class="addfriend likehim" style="padding:0;">Meet Him</a></div>
    	<!--
