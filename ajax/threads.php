...
<?php foreach($nf->wall_message($offset) as $row){?>
	<li class="cf">
		<a href="profile.php?id=<?php echo $row['user_id'];?>" class="imgWrapper l">
        <img src="<?php echo $row['picture'];?>" class="img50" alt=""/></a>
		<div class="dataWrapper">
			<a class="nameWrapper" href="profile.php?id=<?php echo $row['user_id'];?>">
			<?php echo stripslashes(htmlspecialchars_decode($row['user_name'],ENT_QUOTES));?></a>
